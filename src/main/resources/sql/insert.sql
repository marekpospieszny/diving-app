INSERT INTO `divers` (`email`,`name`,`surname`,`password`,`admin`) VALUES
    ('marek.markowski@gmail.com','Marek','Markowski','$2a$12$bLdbsGIbrzdcKlkV/WP2SODMqS2Q.I4e3DWJIfmM8VKPkW62D80oa',false),
    ('jan.nowak@user.pl','Jan','Nowak','$2a$12$bLdbsGIbrzdcKlkV/WP2SODMqS2Q.I4e3DWJIfmM8VKPkW62D80oa',false),
    ('anna.kowalska@wp.pl','Anna','Kowalska','$2a$12$bLdbsGIbrzdcKlkV/WP2SODMqS2Q.I4e3DWJIfmM8VKPkW62D80oa',false),
...
INSERT INTO `locations` (`area`, `country`, `max_depth`, `name`, `rating`) VALUES
    ('Jaworzno','Poland',18,'Koparki',8),
...
INSERT INTO `dives` (`comment`, `date`, `max_depth`, `rating`, `underwater_time_in_minutes`, `diver_id`, `location_id`, `partner_id`) VALUES
    ('cold water, rainy day','2022-04-24',12,5,45,3,3,2),
...
INSERT INTO `messages` (`created_on`, `message_text`, `subject`, `receiver_id`, `sender_id`) VALUES
    ('2022-04-23 07:23:22','Hi, got time for dive tomorrow?','Dive tomorrow',3,2),
    ('2022-04-23 09:15:17','Sure, lets go for it. Hopefully it will not rain.','Dive tomorrow',2,3),
    ('2022-05-11 13:49:01','Thanks for great dive yesterday, it was awesome and we made 110 minutes underwater!','Thanks',1,2),
