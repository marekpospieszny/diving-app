    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit diver:</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<c:url value="/admin/divers/list"/>" class="btn btn-secondary">Return</a></li>
                </ol>
                <div class="card mb-4">
                    <form:form modelAttribute="diver" method="post" action="/admin/divers/update">
                        <jsp:include page="form.jsp"/>
                        <input type="submit" class="btn btn-primary" value="Edit diver">
                    </form:form>
                </div>
            </div>
        </main>
