        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<c:url value="/app/messages/new/${diver.id}"/>"
                                                   class="btn btn-primary">Send new message</a></li>
                </ol>
                <div class="card mb-4">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach items="${messages}" var="message">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/app/messages/details/${message.id}"
