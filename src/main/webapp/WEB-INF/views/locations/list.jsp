        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<c:url value="/admin/locations/add"/>" class="btn btn-primary">Add location</a></li>
                </ol>
                <div class="card mb-4">
                            ...
                            <c:forEach items="${locations}" var="location">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/locations/delete/${location.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
