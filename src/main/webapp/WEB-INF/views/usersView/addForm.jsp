        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<c:url value="/app/divelist/${diver.id}"/>" class="btn btn-secondary">Return</a></li>
                </ol>
                <div class="card mb-4">
                    <form:form modelAttribute="dive" method="post" action="/app/add/dive/${diver.id}">
                        ...
                        <br/>
                        <input type="submit" name="Add dive" class="btn btn-primary">
                    </form:form>
                </div>
            </div>
        </main>
