        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<c:url value="/app/add/dive/${diver.id}"/>"
                                                   class="btn btn-primary">Add dive</a></li>
                </ol>
                <div class="card mb-4">
                            ...
                            <c:forEach items="${dives}" var="dive">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/app/dive/delete/${dive.id}" class="btn btn-danger"
